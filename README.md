...
- Master Report: `PHASE2_FINAL_REPORT.md`
- Delta Analysis (Phase 1 → Phase 2): `PHASE2_DELTA_REPORT.md`
- End-to-End Final Audit: `PHASE2_CANDIDATE_COVERAGE.md`
- Feature Ablation: `PHASE2_GRAPH_ABLATION.md`
- Graph Data Quality: `GRAPH_DATA_QUALITY.md`
- Investigation Agent Benchmark: `INVESTIGATION_EVALUATION.md`
- Evidence Grounding & Anti-Hallucination: `EVIDENCE_GROUNDING_REPORT.md`
- Ring Detection Analysis: `RING_DETECTION_ANALYSIS.md`
- Hard-Negative Safety: `HARD_NEGATIVE_GRAPH_REPORT.md`
- Temporal Generalization: `TEMPORAL_PHASE2_REPORT.md`
- Diagnostic Failure Analysis: `PHASE2_FAILURE_ANALYSIS.md`
